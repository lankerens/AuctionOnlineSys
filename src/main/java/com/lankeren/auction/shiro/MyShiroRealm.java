package com.lankeren.auction.shiro;

import com.lankeren.auction.bean.Account;
import com.lankeren.auction.bean.Identity;
import com.lankeren.auction.bean.Permission;
import com.lankeren.auction.mapper.AccountMapper;
import com.lankeren.auction.mapper.IdentityPermissonMapper;
...
//        super.clearCachedAuthorizationInfo(SecurityUtils.getSubject().getPrincipals());
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        SimpleAuthenticationInfo authenticationInfo =
                new SimpleAuthenticationInfo(realAccount, realAccount.getPassword(), getName());
